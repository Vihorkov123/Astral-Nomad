...
// Конфигурация секторов планеты. size — сторона карты в тайлах (тайл = 32 px).
// needOpen — сколько контейнеров нужно вскрыть, чтобы открыть следующий сектор
// (меньше общего числа: оставляем игроку выбор, рисковать ли остальными).
const BASE_STARS = [
  {
...
// Дальние сектора после концовки «Исследователь»
function genStar(i) {
  const k = i - 4; // 1, 2, 3 ...
  return {
